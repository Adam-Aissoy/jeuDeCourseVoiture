...
private :
    ...
    enum TypeCase { SPACE=' ', WALL='#', DOT='.' ,ROUE='0', GRASS='G', HAUT='A',BAS='B',GAUCHE='C',DROITE='D',DIAGHD='E',DIAGHG='F',DIAGBD='I',DIAGBG='H',DAMIER='@'}; 
...
public :
    ...
    */
    ...
    bool estPixelValide (const int x, const int y) const;
    /**
    ...
    */
    ...
    int grille(const int x, const int y) const;
    /**
