...
int main()
{
    ...
    Texture t1,t2,t3,t4;
    t1.loadFromFile("data/test.png");
    t2.loadFromFile("data/car.png");
    t4.loadFromFile("data/v3.jpeg");

    t1.setSmooth(true);
    t2.setSmooth(true);
    t4.setSmooth(true);
// et celui du VoitureJoueur
    Sprite sBackground(t1), sCar(t2),sCars(t4);
